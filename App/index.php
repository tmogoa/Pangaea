...
<?php
 ...
 ?>
        ...
        <div class="flex text-gray-500 flex-row bg-white shadow-md rounded justify-between w-10/12 mx-auto h-96 mt-6">

            <div class="mb-2 w-11/12 sm:w-6/12 sm:h-full overflow-hidden rounded-tl rounded-bl flex-shrink-0">
            ...
            <div class="flex flex-col mx-4 p-4">
                ...
                <div class="w-full flex flex-col mb-3">
                    <span class="mb-2 text-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit</span>
                    <span class="text-lg mb-1">Maecenas volutpat blandit aliquam etiam erat velit scelerisque in dictum.</span>
                    <div class="text-sm whitespace-normal overflow-ellipsis flex-grow-0 px-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
                </div>
        ...
        <div class="grid grid-cols-3 gap-3 text-gray-500 w-10/12 mx-auto mt-6 mb-4">
            <?php 
                for ($i=0; $i < 10; $i++) { 
            ?>
                    ...
                    <div class="flex justify-center items-center">
                        <div class="flex flex-col p-4 sm:w-96 m-1 border rounded justify-center bg-white shadow-md">
